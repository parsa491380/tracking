...
export default function GetLocByClick() {
  ...
  const { activeOnclick, firstLoc, setFirstLoc, secondLoc, setSecondtLoc } =
  ...
  // C:\Users\o.akbari\Desktop\proj\project\tracking\src\components\img\267540.webp
